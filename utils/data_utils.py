...
def get_loader(args):
    ...
    if args.dataset == "cifar10":
        ...
        test_transform = transforms.Compose([
            ...
            transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = ip_102(root=args.data_root, is_train=True, transform=train_transform)
        testset = ip_102(root=args.data_root, is_train=False, transform=test_transform)
        ...
        test_transform = transforms.Compose([
            ...
            # transforms.Normalize([0.8416, 0.867, 0.8233], [0.2852, 0.246, 0.3262])])
            transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = AppleLeaf(root=args.data_root, is_train=True, transform=train_transform)
        testset = AppleLeaf(root=args.data_root, is_train=False, transform=test_transform)
