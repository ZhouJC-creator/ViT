...
def main():
    ...
    parser.add_argument("--dataset", choices=["cifar10", "cifar100", "ip_102", "AgriculturalDisease", "PlantLeave", "PlantPathology", "PlantDoc",
                                 "AppleLeaf9", "AppleLeaf", "soyloc", "cotton", "CUB",
                                 "dog", "car", "air"], default="CUB_200_2011",
                        help="Which dataset.")
