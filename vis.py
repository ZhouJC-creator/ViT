...
model = VisionTransformer(config,img_size=448, num_classes=12, smoothing_value=0, zero_head=False)
model.load_from(np.load("/home/zjc/project/models/Visual/checkpoint/ViT/WheatData_17_0.90407.bin"))
model.eval()
...
im = Image.open("/home/zjc/project/models/Visual/imgs/wheat_cls2.jpg")
x = transform(im)
x.size()
